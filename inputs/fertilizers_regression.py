...
land_data = pd.read_csv("Fertilizers_input.csv")
...
def save_model(country_name, model):
    ...
    dir_path = os.getcwd()
    try:
        os.mkdir(dir_path + "//" + "Fertilizers_data")
        
    except:
        pass

    try:
        os.mkdir(dir_path+ "//Fertilizers_data" + "//"+country_name)
    except:
        pass
    file_path = dir_path + "//" + "Fertilizers_data" + "//" + country_name + "//" + filename
    print(file_path)
...
data = pd.read_csv('Fertilizers_input.csv')
