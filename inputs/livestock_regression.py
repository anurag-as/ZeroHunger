...
land_data = pd.read_csv("Livestock.csv")
...
def save_model(country_name, model):
    ...
    dir_path = os.getcwd()
    try:
        os.mkdir(dir_path + "//" + "Livestock_data")
        
    except:
        pass

    try:
        os.mkdir(dir_path + "//Livestock_data" + "//"+country_name)
    except:
        pass
    file_path = dir_path + "//" + "Livestock_data" + "//" + country_name + "//" + filename
    print(file_path)
